    ...
    >
      <CollapsibleTrigger className="w-full rounded-md">
        <div
          ...
          } px-3 py-2 lg:p-2 cursor-pointer rounded-md text-base lg:text-sm font-medium text-slate-600 hover:text-slate-700 dark:text-slate-100 dark:hover:text-slate-50 transition-colors ${
            isActive
          ...
          filteredUsers?.map((user) => {
            ...
            return (
              <NavLink
                ...
                className={({ isActive }) =>
                  clsx(
                    "flex items-center gap-x-2 text-base lg:text-sm font-medium p-2 rounded-md overflow-hidden",
              ...
              >
                ...
                >
                  <AvatarImage
                    ...
                    alt={user?.firstName}
                  />
                  <AvatarFallback className="text-slate-600 dark:text-slate-100 font-medium text-base lg:text-sm">
